...
drop index  idx_libros_id_editorial on libros;
...
-- Ejercicio 6: Crear índice único en editoriales
CREATE UNIQUE INDEX idx_editoriales_id_editorial ON editoriales (id_editorial);

-- Ejercicio 7: Índice primario en id_libro
ALTER TABLE libros
